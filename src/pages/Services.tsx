        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="glass-card p-10 rounded-3xl group cursor-pointer"
            >
              <div className="w-16 h-16 bg-accent/20 rounded-2xl flex items-center justify-center text-3xl text-accent mb-8 group-hover:bg-accent group-hover:text-white transition-all duration-300">
                {service.icon}
              </div>
